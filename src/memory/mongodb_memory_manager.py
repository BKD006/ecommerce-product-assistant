...
class MongoConversationManager:
    ...
    def should_summarize(self, session_id: str, threshold: int = 20) -> bool:
    ...
    def get_messages_for_summary(self, session_id: str, limit: int = 15):
    ...
    def delete_old_messages(self, session_id: str, keep_last: int = 5):
        ...
        ids = [m["_id"] for m in messages_to_delete]

        self.messages.delete_many({"_id": {"$in": ids}})
